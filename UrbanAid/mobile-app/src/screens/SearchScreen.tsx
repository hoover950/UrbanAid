...
const SearchScreen: React.FC = () => {
  ...
  const getUtilityTypeLabel = (type: UtilityType): string => {
    const labels: Record<UtilityType, string> = {
      water_fountain: t('utilityTypes.waterFountain'),
      restroom: t('utilityTypes.restroom'),
      charging_station: t('utilityTypes.chargingStation'),
      parking: t('utilityTypes.parking'),
      wifi: t('utilityTypes.wifi'),
      atm: t('utilityTypes.atm'),
      phone_booth: t('utilityTypes.phoneBooth'),
      bench: t('utilityTypes.bench'),
    };
